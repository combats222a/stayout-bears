...
type Glyph =
  | 'star' | 'book' | 'gem' | 'compass' | 'coin' | 'hammer' | 'cross' | 'ban'
  | 'skull' | 'claw' | 'fire' | 'wrench' | 'swords' | 'flag' | 'shield'
  | 'bolt' | 'skull2' | 'egg';
...
const DEFAULT_STYLE: CategoryStyle = { bg: '#20242c', fg: '#8b93a1', glyph: 'star' };

function Glyph({ type, color }: { type: Glyph; color: string }) {
...
export default function AchievementIcon({ category, size = 40 }: AchievementIconProps) {
