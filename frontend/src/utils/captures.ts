...
function durationMinFor(location: CaptureLocation): number {
...
function serverTimeOnDate(baseUtcDate: Date, hour: number, minute: number): Date {
...
function matchesWeekday(location: CaptureLocation, dayUtcDate: Date): boolean {
...
export function getNextOccurrence(location: CaptureLocation, now: Date = new Date()): CaptureOccurrence {
...
export interface CaptureStatus extends CaptureOccurrence {
  isActive: boolean;
  isSoon: boolean;
  msToStart: number;
  msToEnd: number;
...
export function getCaptureStatus(location: CaptureLocation, now: Date = new Date()): CaptureStatus {
