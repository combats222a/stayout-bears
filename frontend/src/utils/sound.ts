...
function playTones(notes: Tone[]): void {
  try {
...
export function playShiningWarningSound(): void {
...
export function playAnomalyWarningSound(): void {
...
export function playCaptureStartSound(): void {
  playTones([
