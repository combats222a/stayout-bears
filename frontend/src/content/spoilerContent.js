...
export const ANOMALY_SPOILER = {
  icon: '🥶',
  title: 'Как пользоваться разделом «Аномальные прорывы / Ледяная жара»',
  blocks: [
    {
      heading: 'Что это?',
      body: 'Раздел показывает расписание аномальных прорывов (Ледяная жара) в Stay Out. Событие идёт по реальному времени GMT+00:00 и одинаково для всех игроков — не зависит от клана и не требует ввода игрового времени.',
    },
    {
      heading: 'Расписание',
      body: [
