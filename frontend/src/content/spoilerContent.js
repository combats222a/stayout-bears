...
export const DRAUGS_SPOILER = {
  icon: '💀',
  title: 'Как пользоваться разделом «Драуги»',
  blocks: [
    {
      heading: 'Что это?',
      body: 'Раздел «Драуги» позволяет отслеживать время появления драугов в Stay Out. Здесь отображаются все точки спавна, квадраты карты, время последней смерти и оставшееся время до следующего появления. Информация обновляется участниками клана и помогает эффективно планировать маршруты фарма.',
    },
    {
      heading: 'Как пользоваться',
      body: [
        '«Сейчас» — отмечает, что драуг был убит только что.',
        '«Исчез» — отмечает, что драуг пропал без убийства.',
        'После обновления автоматически рассчитываются: время следующего спавна, сколько прошло с момента смерти и кто последним обновил информацию.',
      ],
    },
    {
...
export const ANOMALY_SPOILER = {
  icon: '🥶',
  title: 'Как пользоваться разделом «Аномальные прорывы / Уледная жара»',
  blocks: [
    {
      heading: 'Что это?',
      body: 'Раздел показывает расписание аномальных прорывов (Уледная жара) в Stay Out. Событие идёт по реальному времени GMT+00:00 и одинаково для всех игроков — не зависит от клана.',
    },
    {
      heading: 'Расписание',
      body: [
        '🟠 Оранжевая рамка (предупреждение): 07:30–07:50 и 19:30–19:50.',
        '🟢 Зелёная рамка (контест идёт): 07:50–10:00 и 19:50–22:00.',
        'Всё остальное время — обычное ожидание следующего окна.',
      ],
    },
    {
      heading: 'Якорь Z',
      body: 'Как и на «Горе Сияния», можно указать текущее игровое время — это удобно для справки, но на само расписание прорывов не влияет: контест всегда идёт строго по реальному GMT+00:00.',
    },
    {
      heading: 'Часовой пояс',
      body: 'Расписание фиксировано по GMT+00:00, но время на карточках показывается в часовом поясе твоего устройства — пересчёт происходит автоматически.',
    },
    {
      heading: 'Возможности',
      body: [
        'точный отсчёт до ближайшего прорыва',
        'обратный отсчёт до конца активного окна',
        'звуковое уведомление в 07:30 и 19:30 (по желанию)',
        'страница не связана с «Горой Сияния»',
      ],
    },
  ],
};
