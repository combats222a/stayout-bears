...
export const ANOMALY_SPOILER = {
  ...
  blocks: [
    {
      heading: 'Что это?',
      body: 'Раздел показывает расписание аномальных прорывов (Уледная жара) в Stay Out. Работает точно как «Гора Сияния»: ты вводишь текущее игровое время (Якорь Z), и Bear Tracker сам считает, когда наступят нужные игровые часы.',
    },
    {
      heading: 'Как пользоваться',
      body: 'Нажми «Установить время» и введи игровое время, которое видишь прямо сейчас в игре. Локация зафиксирована на GMT +00:00 — выбирать её не нужно. После этого автоматически считаются все ближайшие циклы.',
    },
    {
      heading: 'Расписание (по игровому времени)',
      body: [
        '🟠 Оранжевая рамка (предупреждение): 07:30–07:50 и 19:30–19:50.',
        '🟢 Зелёная рамка (прорыв идёт): 07:50–10:00 и 19:50–22:00.',
        'Всё остальное игровое время — обычное ожидание следующего цикла.',
      ],
    },
    {
      heading: 'Возможности',
      body: [
        ...
        'звуковое уведомление в момент начала предупреждения (по желанию)',
        'страница не связана с «Горой Сияния» — свой отдельный якорь',
      ],
    },
  ],
};
