...
export const DRAUGS_SPOILER = {
  ...
  blocks: [
    {
      heading: 'Что это?',
      body: 'Драуги — одни из самых востребованных мутантов в Stay Out, поскольку с них добывают ценный лут и ресурсы. Из-за длительного времени возрождения игрокам важно знать, когда и где появится следующий драуг. Именно для этого создан раздел «Драуги».',
    },
    {
      heading: 'Как это работает',
      body: 'Сервис позволяет отслеживать таймеры спавна драугов, фиксировать время последнего убийства, видеть квадраты карты с местами появления и получать актуальную информацию от участников клана. Благодаря этому можно заранее планировать маршруты фарма, не тратя время на проверку пустых точек.',
    },
    {
      heading: 'Кому пригодится',
      body: 'Раздел особенно полезен как одиночным игрокам, так и кланам, которые регулярно фармят драугов и хотят контролировать все места их появления. Общая синхронизация данных позволяет каждому участнику видеть актуальное время респавна и историю последних обновлений.',
    },
  ],
};
