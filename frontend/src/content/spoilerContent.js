  ...
  blocks: [
    ...
    },
    {
      ...
      body: [
        ...
        'Цвет звезды:',
        '🔵 Синяя — точка добавлена в избранное, до начала захвата больше часа.',
        '🟡 Жёлтая — точка в избранном, до начала захвата осталось меньше часа.',
        '🔴 Красная — точка в избранном, захват уже идёт.',
      ],
    },
    {
      heading: 'Возможности',
