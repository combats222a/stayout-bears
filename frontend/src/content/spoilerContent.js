...
export const CAPTURES_SPOILER = {
  ...
  blocks: [
    ...
    {
      heading: 'Избранное и звуковое уведомление',
      body: [
        '⭐ Звёздочка — добавляет точку в избранное. Избранные точки отображаются вверху таблицы.',
        '🔔 Значок рупора — звук в начале захвата (по умолчанию отключён, включается для каждой точки отдельно).',
        'Цветовая индикация звезды: 🔵 синяя — точка в избранном, до захвата больше часа; 🟡 жёлтая — избранная точка, захват начнётся менее чем через час; 🔴 красная — избранная точка, захват идёт прямо сейчас.',
      ],
    },
    {
      heading: 'Возможности',
