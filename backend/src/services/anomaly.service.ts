import * as repo from '../repositories/anomaly.repository';
import type { AuthedRequest, ServiceResult } from '../types/http';

export async function getAnomaly(req: AuthedRequest): Promise<ServiceResult> {
...
export async function setAnomaly(req: AuthedRequest): Promise<ServiceResult> {
